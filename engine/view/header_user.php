    ...
    <div class="container-fluid">
        <nav class="navbar justify-content-around">
            <div class="navbar-brand logo">
                <img class="img-fluid" src="resources/img/1.png" alt="UCCI Portal">
            </div>
            <ul class="nav flex-column flex-sm-row">
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?php echo base_url; ?>">Профиль</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?php echo base_url .'settings'; ?>">Настройки</a>
                </li>
                <li class="nav-item">
